...
export const COLORS = {
  ...
  expense: '#FF4757', // Radiant Red
  income: '#2ED573',  // Fresh Emerald
  chart: ['#6366F1', '#2ED573', '#FFA502', '#FF4757', '#747D8C', '#ECCC68']
};

const IconWrapper = ({ children, color }: { children?: React.ReactNode, color: string }) => (
  <div className={`w-11 h-11 rounded-2xl flex items-center justify-center shadow-sm border border-white/40 backdrop-blur-sm transition-transform hover:scale-105`} 
...
export const CATEGORY_ICONS: Record<string, React.ReactNode> = {
  ...
  'Hóa đơn': (
    <IconWrapper color="#1E90FF">
      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M4 2v20l2-1 2 1 2-1 2 1 2-1 2 1 2-1 2 1V2l-2 1-2-1-2 1-2-1-2 1-2-1-2 1-2-1Z"/><path d="M14 8H8"/><path d="M16 12H8"/><path d="M13 16H8"/></svg>
    </IconWrapper>
  ),
  'Giải trí': (
    <IconWrapper color="#8B5CF6">
      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><line x1="6" y1="12" x2="10" y2="12"/><line x1="8" y1="10" x2="8" y2="14"/><rect x="2" y="6" width="20" height="12" rx="2"/><circle cx="15.5" cy="15.5" r=".5" fill="currentColor"/><circle cx="18.5" cy="12.5" r=".5" fill="currentColor"/></svg>
    </IconWrapper>
  ),
  'Khác': (
    <IconWrapper color="#747D8C">
      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="m7.5 4.27 9 5.15"/><path d="M21 8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16Z"/><path d="m3.3 7 8.7 5 8.7-5"/><path d="M12 22V12"/></svg>
    </IconWrapper>
  ),
  'Lương': (
    <IconWrapper color="#2ED573">
